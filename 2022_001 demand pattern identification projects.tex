...
\lfoot{\textcolor{blueM}{Fraga, T.B. (\the\year). Identificão de padrões de demanda. \emph{Mad Scientists Diary}.}}
...
\vspace{5mm}
    ...
    \center\Large{\textbf{Identificão de padrões de demanda}} 
    \vspace{3mm}
...
\cite{BusingerRead1999} aplicam um sistema de agrupamento de itens utilizando um diagrama de plotagem em estrela considerando oito características admensionais dos dados de séries temporais: coeficiente de variação, número de zeros, tendência, picos (outliers), sazonalidade, corridas, assimetria e autocorrelação. Tais características são utilizadas pelos autores para identificação de quais modelos ARIMA são mais adequados para os diferentes grupos identificados. 
...
Estes projetos serão desenvolvidos através dos 6 atividades, conforme descrito a seguir:\\
...
Atividade 6: preparação de relatórios e artigos para congressos e / ou revistas.
...
\begin{itemize}
    ...
    \item artigos apresentados em congressos.
\end{itemize}
