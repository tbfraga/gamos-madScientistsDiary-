...
Em alguns casos a demanda de um item pode ser representada por uma distribuição normal (i.e. distribuição de probabilidade contínua com esperança matemática (\mi) e desvio padrão (\sigma)), nesses casos dizemos que o item apresenta uma \emph{demanda de padrão normal}. 



Embora a suposição de normalidade deva representar razoavelmente muitos casos do mundo real, 
